...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_apiHttpPublicServices__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__services_apiStorageService__ = __webpack_require__(27);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        result.bill_cycles.forEach(function (el) {
            items.push({
                ...
                options: [
                    ...
                    { name: "Tạo bản in", icon: "print", color: "primary", next: "PDF", url: __WEBPACK_IMPORTED_MODULE_11__services_apiStorageService__["a" /* ApiStorageService */].resourceServer + "/db/pdf-invoices/" + el.bill_cycle, method: "GET" },
                    { name: "Xem danh sách", icon: "list-box", color: "secondary", next: "LIST", url: __WEBPACK_IMPORTED_MODULE_11__services_apiStorageService__["a" /* ApiStorageService */].resourceServer + "/db/json-invoices/" + el.bill_cycle, method: "GET" }
                ]
            });
        });
        return {
        ...
        results.forEach(function (el) {
            items.push({
                ...
                options: [
                    ...
                    { name: "In đơn lẻ", icon: "print", color: "primary", next: "PDF", url: __WEBPACK_IMPORTED_MODULE_11__services_apiStorageService__["a" /* ApiStorageService */].resourceServer + "/db/pdf-invoices/" + el.bill_cycle + "/" + el.cust_id, method: "GET" },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__apiStorageService__ = __webpack_require__(27);
...
var ApiStorageService = /** @class */ (function () {
    ...
    ApiStorageService.resourceServer = 'https://c3.mobifone.vn/qld';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_apiStorageService__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_apiStorageService__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__services_apiStorageService__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__services_apiHttpPublicServices__ = __webpack_require__(31);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_29_angular_webstorage_service__["c" /* StorageServiceModule */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_apiStorageService__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_apiStorageService__ = __webpack_require__(27);
                            ...
                            items: [
                                ...
                                { type: "button",
                                    options: [
                                        ...
                                        { name: "Xác nhận OTP", next: "CALLBACK", url: __WEBPACK_IMPORTED_MODULE_6__services_apiStorageService__["a" /* ApiStorageService */].authenticationServer + "/confirm-key", token: res.data.token }
                                    ]
                                }
                            ]
                        }
