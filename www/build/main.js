...
var DynamicMediasPage = /** @class */ (function () {
    ...
    DynamicMediasPage.prototype.fileChange = function (event) {
        var _this = this;
            ...
            var processImages = new Promise(function (resolve, reject) {
                ...
                for (var key in files_1) {
                    if (!isNaN(parseInt(key))) {
                        _this.apiImageService.resizeImage(files_1[key].name, files_1[key], 480)
                            .then(function (data) {
    ...
    DynamicMediasPage.prototype.onClickShortDetails = function (btn, item) {
        console.log(btn, item);
        this.processCommand(btn);
    };
    DynamicMediasPage.prototype.onClickActions = function (btn, item) {
        console.log(btn, item);
        this.processCommand(btn);
    };
                            ...
                            canvas_1.toBlob(function (blob) {
                                ...
                                reader.onload = function () {
                                    ...
                                    resolve({
                                        ...
                                        subtitle: (file.lastModified ? new Date(file.lastModified).toLocaleDateString() : file.lastModifiedDate) + "(" + originOrientation_1 + ")",
