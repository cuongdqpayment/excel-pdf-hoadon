...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_apiHttpPublicServices__ = __webpack_require__(250);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CustomerPage = /** @class */ (function () {
    function CustomerPage(navCtrl, http) {
        this.navCtrl = navCtrl;
        this.http = http;
        this.customers = [];
    ...
    CustomerPage.prototype.getCustomers = function () {
        ...
        this.http.getAllCutomers()
            ...
            console.log('MAX Ma khach hang', _this.maxCurrentId);
        })
            .catch(function (err) {
