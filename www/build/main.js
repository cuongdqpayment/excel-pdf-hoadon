...
var ParametersPage = /** @class */ (function () {
    ...
    ParametersPage.prototype.ngOnInit = function () {
        ...
        this.http.getParamters()
            ...
            console.log('tree', _this.parameters);
            loading.dismiss();
        })
            .catch(function (err) {
            _this.parameters = [];
